# چک‌لیست Production — CentralPay Bridge 0.6.0-rc2
...
نسخهٔ `0.6.0-rc2` هنوز Release Candidate است؛ قبل از هر deployment یا تغییر مهم، وضعیت واقعی source/CI/سرور را بررسی کنید.
