# چک‌لیست Production — CentralPay Bridge 0.6.0-rc1
...
نسخهٔ `0.6.0-rc1` هنوز Release Candidate است؛ قبل از هر deployment یا تغییر مهم، وضعیت واقعی source/CI/سرور را بررسی کنید.
