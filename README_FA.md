...
- **فاز ۲ — اطلاع‌رسانی به ربات و بازیابی (این نسخه):** تحویل امن پرداخت‌های
  تأییدشده به API ربات، کدهای دلیل صریح، ورکر مستقل، و صفحات وضعیت برای
  پرداخت‌کننده. ✅
- فازهای بعدی: استقرار Docker، نصاب، دستور مدیریتی `centralpay`،
  پشتیبان‌گیری، ربات تلگرام مدیریتی.
