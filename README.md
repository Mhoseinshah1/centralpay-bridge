...
Current application version: **0.6.0-rc2**. Current Alembic head on this branch: **0012**.
...
`0.6.0-rc2` is a pre-release. Do not infer go-live readiness from an old checklist or audit snapshot; use current source, current CI, the current operational checklist, and the cumulative risk history together.
